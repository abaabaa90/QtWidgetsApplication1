...
// * @brief  �Ż���C++���ߣ����ڴ��ַ������ļ���ɨ��ֵ��
// *
// * ���ͷ�ļ��ṩ�˸�Ч�ġ��������C/C++�ַ��������������`scanf`��`atoi`�ȣ��Ĺ��ߡ�
// *
// * ���������ַ���ת��Ϊ�����Լ����ַ������ļ�ɨ��ֵ��ʵ�ù��ߡ�
// *
// * ��ο��ĵ��Ի�ȡ�й����ʹ�������ṩ���ִ������Ͱ�ȫ��Ӧ�����滻��׼C������ָ����
// *
// * 1. C/C++�����º������Խ�һ��/���char*��stringת��Ϊ���֣�
...
// *    7. std::get_time
// * ��Щ����Ӧ�ñ��滻Ϊ��
// *    1. vtk::from_chars, vtk::scan_int, vtk::scan_value, �����Ҫת��һ������
// *    2. vtk::scan, �����Ҫת��һ��/������֣���ѡʹ���ض���ʽ��
// *
// * 2. C/C++�����º�����stdin/�ļ�ɨ��һ��/������֣�
// *    1. scanf, scanf_s, vscanf, vscanf_s,
// *    2. fscanf, fscanf_s, vfscanf, vfscanf_s,
// *    3. std::cin, std::ifstream, vtksys::ifstream
// * ��Щ����Ӧ�ñ��滻Ϊ��
// *    1. vtk::scan_value, �����Ҫת��һ������
// *    2. vtk::input, vtk::scan, �����Ҫת��һ��/������֣���ѡʹ���ض���ʽ��
// */
...
//    {
//        static constexpr std::array<fast_float::chars_format, 5> std_to_fast_float_chars_format = { {//��̬�����������ڸ�ʽӳ��
